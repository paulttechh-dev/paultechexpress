          ...
          {mode === 'login' && (
            <div className="flex items-center gap-2 ml-1">
              <label className="relative flex items-center cursor-pointer group">
                ...
                />
                <div className="w-5 h-5 bg-slate-950 border border-white/10 rounded-lg peer-checked:bg-blue-600 peer-checked:border-blue-500 transition-all flex items-center justify-center group-hover:border-white/20">
                  <svg 
                ...
                <span className="ml-3 text-xs font-medium text-slate-400 group-hover:text-slate-300 transition-colors">
                  Lembrar meu e-mail
                </span>
              </label>
            </div>
